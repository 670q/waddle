...
export const StartChallengeModal = ({ visible, onClose, onStart }: StartChallengeModalProps) => {
    ...
    const handleAddHabit = (habitData: { title: string; icon: string; time: string; frequency: number[] }) => {
        ...
        addHabit(newHabit);
        // Auto-select the newly added habit
                                    ...
                                    {habits.length === 0 ? (
                                        <View className="items-center py-8">
                                            ...
                                            <Text className="text-slate-400 mt-2 text-center">
                                                {isRTL ? 'لا توجد عادات، أضف واحدة!' : 'No habits found. Add one!'}
                                            </Text>
                                        </View>
                                    ) : (
                                        habits.map((habit) => (
