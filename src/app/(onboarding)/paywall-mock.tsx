...
export default function PaywallMockScreen() {
    ...
    const handleComplete = () => {
        ...
        // Will auto-redirect to tabs via _layout
    };
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            <ScrollView contentContainerStyle={{ padding: 24, paddingBottom: 100 }}>
                ...
                <View className="items-center mb-8 mt-4">
                    ...
                    <Text className="text-3xl font-bold text-slate-800 text-center mt-4 px-4">
                        Unlock your full potential with Waddle Pro.
                    </Text>
                </View>
                ...
                <View className="bg-[#FF9F43] p-6 rounded-2xl items-center mb-6 shadow-lg shadow-orange-200">
                    <Text className="text-white font-black text-xl mb-1 uppercase tracking-wide">7 Days Free Trial</Text>
                    <Text className="text-white text-base opacity-90">Then $19.99/year. Cancel anytime.</Text>
                </View>
            ...
            <View className="absolute bottom-10 left-6 right-6 gap-4">
                ...
                >
                    <Text className="text-slate-400 font-medium text-sm">No thanks, I'll continue with the limited version.</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
